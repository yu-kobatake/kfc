        ...
        ?>
                ...
                <form method="POST" action="animal_confirm.php" enctype="multipart/form-data">
                    <table class="ta1 animal_post">
                        ...
                        <tr>
                            <th>掲載タイトル<br></th>
                            <td colspan="3"><textarea name="title" class="txtareamini"
                                    placeholder="例）マイペースで優しい柴犬の男の子"><?= es($title); ?></textarea>
                            </td>
                        </tr>
                        <tr class="column3">
                            <th>掲載画像<br>(3枚選択)</th>
                        ...
                        <tr>
                            <th>年齢</th>
                            <td colspan="3"><input type="text" name="age" placeholder="例）5才3ヶ月" value="<?= $age; ?>">
                            </td>
                        </tr>
                        <tr>
