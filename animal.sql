...
INSERT INTO `animal` (`animal_id`, `title`, `image_1`, `image_2`, `image_3`, `kind`, `gender`, `age`, `area_1`, `area_2`, `area_3`, `animal_area`, `animal_character`, `other`) VALUES
(1, '元気なミニチュアダックスフンド（茶）', '1_image1.jpg', '1_image2.jpg', '1_image3.jpg', '犬', '♂', '1歳7か月', '石川県', '富山県', '福井県', '石川県', '元気な男の子', '１テキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキスト'),
(2, '可愛いミニチュアダックスフンド（黒）', '2_image1.jpg', '2_image2.jpg', '2_image3.jpg', '犬', '♀', '2歳1か月', '大阪府', '京都府', '奈良県', '大阪府', '可愛い女の子', '２テキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキスト'),
...
(5, '元気な黒猫', '5_image1.jpg', '5_image2.jpg', '5_image3.jpg', '猫', '♂', '0歳11ヵ月', '岩手県', '青森県', '秋田県', '岩手県', '元気な男の子', '５テキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキスト'),
...
(7, 'test1', '7_image1.jpg', '7_image2.jpg', '7_image3.jpg', '犬', '♂', '1ヵ月', '石川県', '富山県', '福井県', '石川県', 'test1', 'test1'),
(8, 'test2', '8_image1.jpg', '8_image2.jpg', '8_image3.jpg', '猫', 'test2', '2ヵ月', '石川県', '富山県', '福井県', '石川県', 'test2', 'test2'),
(9, 'test', '9_image1.jpg', '9_image2.jpg', '9_image3.jpg', '猫', 'test3', '3ヵ月', '石川県', '富山県', '福井県', '石川県', 'test3', 'test3');
